---@brief
---
--- LSP configuration for typescript-language-server from nvim-lspconfig
---
...
return {
	...
	root_dir = function(bufnr, on_dir)
		...
		-- manager lock file.
		local root_markers = { "package-lock.json", "yarn.lock", "pnpm-lock.yaml", "bun.lockb", "bun.lock", "index.html" }
